    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.adminId) {
            this.$http({
              url: this.$http.adornUrl(`/seed-platform/admin/info/${this.dataForm.adminId}`),
              method: 'get',
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.createdAt = data.admin.createdAt
              }
            })
          }
        })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/seed-platform/admin/${!this.dataForm.adminId ? 'save' : 'update'}`),
              method: 'post',
