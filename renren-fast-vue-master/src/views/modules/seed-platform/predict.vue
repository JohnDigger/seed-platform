                ...
                <div>
                  <el-row>
                    <el-col :span="12">
                      ...
                      <el-select v-model="value" placeholder="请选择种子" class="left-up">
                        <el-option
                    ...
                    <el-col :span="12">
                      ...
                      <el-button type="primary" plain class="left-up" style="margin-top: 10px">主要按钮</el-button>
                    </el-col>
                  </el-row>
                </div>
              </div>
        ...
        <div>
          <el-row>
            <el-col :span="12">
              ...
              <el-input v-model="input" class="left-input" placeholder="摄氏度"></el-input>
            </el-col>
            <el-col :span="12">
              <div><h2 class="left-up">成熟种子含水量</h2></div>
              <el-input v-model="input" class="left-input" placeholder="百分比"></el-input>
            </el-col>
          </el-row>
        </div>
        ...
        <div>
          <el-row>
            ...
            <el-col :span="12">
              ...
              <el-radio-group v-model="seedHard" class="left-up">
                <el-radio label="长周期"></el-radio>
                <el-radio label="短周期"></el-radio>
              </el-radio-group>
            </el-col>
          </el-row>
        </div>
